# Pages
## Main page
- [ ] Banner at the top of page with text "My Trip Log"
...
- [ ] Destination and dates are mandatory but accommodation is optional
## Second info page
...
- [ ] All fields for the trip should be stored in a single table